...
Assim, passamos para a segunda solução. Aplicaremos as transformações inversas das aplicadas nos
vértices das cartas para que o sistema de coordenadas da posição do toque seja a mesma dos vértices.

Seja \(\left\{e_1, e_2\right\}\) uma base de \(\mathbb{R}²\), dizemos que os vértices \(w, x, y, z\) é
um retângulo se 

Dado que uma carta está sendo arrastada 

Para embaralhar as cartas, o usuário deve arrastar todas as cartas para cima e para baixo pelo menos 3
vezes. A solução para este problema foi aplicar o classificador de k vizinhos próximos.