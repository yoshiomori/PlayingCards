...
Para desenhar o fundo, foi necessário especificar 4 vértices para serem usados na contrução de
dois triângulos, a posição destes vertices deve variar com as dimenções da tela do aparelho.
Conforme a posição a textura aplicada em cada pixel do objeto deve variar com as dimeções do
aparelho.